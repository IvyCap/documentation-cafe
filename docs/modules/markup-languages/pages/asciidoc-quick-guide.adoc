...
The https://asciidoc-wg.eclipse.org/[Eclipse Foundation] maintains the https://asciidoc.org[AsciiDoc] project. The full https://docs.asciidoctor.org/asciidoc/latest/[AssciiDoc Specification is found here]
...
[#bookmark-b]#Inline anchors can be applied to a phrase such as this one.#

anchor:bookmark-c[]Use a cross-reference to link to this location.

[[bookmark-d,last paragraph]]The xreflabel attribute is used as link text in the cross-reference link.
...
TIP: Turning it off and on does fix many issues
