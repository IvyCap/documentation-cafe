...
This is from a project I started to document https://apidocs.tenfold.com/[Tenfold's Public APIs] in OpenAPI specifications. Due to some organization changes within Tenfold this project was not completed. 
