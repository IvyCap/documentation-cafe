...
Markdown is a lightweight markup language created in 2004. It is designed to convert easy to write text to html or xhtml. The details of the current specification known as https://commonmark.org/[CommanMark] you can https://spec.commonmark.org/[find here]. To add additional functionality different flavors of Markdown were developed over the years. This guide is based on the https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax[GitHub Flavored markdown]
